...
public class PhasePrimaryKeyGenerator implements IdentifierGenerator {
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) {
        ...
        try {
            ...
            String formattedPrimaryKey = String.format("PHS%06d", nextPrimaryKeyValue);
    ...
    private Long getNextPrimaryKeyValueFromDatabase(Connection connection) throws SQLException {
        ...
        String query = "SELECT MAX(CAST(SUBSTRING(phase_id, 4) AS UNSIGNED)) FROM phase";
