...
public class WalletPrimaryKeyGenerator implements IdentifierGenerator {
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) {
        ...
        try {
            ...
            String formattedPrimaryKey = String.format("WLT%06d", nextPrimaryKeyValue);
    ...
    private Long getNextPrimaryKeyValueFromDatabase(Connection connection) throws SQLException {
        String query = "SELECT MAX(CAST(SUBSTRING(wallet_id, 4) AS UNSIGNED)) FROM user_wallet";
